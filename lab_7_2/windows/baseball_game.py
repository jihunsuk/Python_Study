...
def is_validated_number(user_input_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    result = (is_digit(user_input_number) == True
                and is_between_100_and_999(user_input_number) == True
                and is_duplicated_number(user_input_number) == False)
    # ==================================
    return result
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    sa = set(user_input_number)
    sb = set(random_number)
    ball = len(sa.intersection(sb)) - strikes
    result = [strikes, ball]
    # ==================================
    return result
...
def main():
    ...
    #         break
    #
    #     ans = get_strikes_or_ball(user_input, random_number)
    #     Strikes = ans.pop(0)
    #     Balls = ans.pop(0)
    #     print("Strikes : " + str(Strikes) + " , Balls : " + str(Balls))
    #     if Strikes == 3:
    #         s = input("You win, one more(Y/N)?")
    #         is_zero = s == "0"
    #         if is_zero:
    #             break
    #         while not is_yes(s) and not is_no(s):
    #             print("Wrong Input, Input again")
    #             s = input("You win, one more(Y/N)?")
    #             is_zero = s == "0"
    #             if is_zero:
